...
def helptexttospeech():
    ...
    helpTextToSpeech =   "╔══[ T E X T   T O   S P E E C H ]" + "\n" + \
                         ...
                         "╠ " + mykey + "cy : Welsh" + "\n" + \
                         "╚══[ Jangan Typo ]" + "\n" + "\n\n" + \
                          "Contoh : " + mykey + "say-id Yudha Ganteng"
...
def helptranslate():
    ...
    helpTranslate =    "╔══[ T R A N S L A T E ]" + "\n" + \
                       ...
                       "╠ " + mykey + "he : Hebrew" + "\n" + \
                       "╚══[ Jangan Typo ]" + "\n" + "\n\n" + \
                         "Contoh : " + mykey + "tr-id Yudha Ganteng"
...
#==============================================================================#
    ...
    #==============================================================================#
                    ...
                    if group.preventJoinByTicket == True:
                        ...
                        gQr = "Terbuka"
                        gTicket = "line.me/R/ti/g/{}".format(str(cl.reissueGroupTicket(group.id)))
                    ret_ = "╔════════Grup Info═════════"
