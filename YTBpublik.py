...
cl = yuda.LINE()
#cl.login(qr=True)
cl.login(token='isi_token_mu')#ranita
cl.loginResult()#
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "uc99a2ab255130014a4ca4f3c3d9dad00"}
					cl.sendText(msg.to,"MyCreator")
					ki.sendMessage(msg)
					msg.contentType = 13
					msg.contentMetadata = {'mid': "uecc57cb55f480ee2a45d81434a9b864d"}
					cl.sendText(msg.to,"MyCreator")
					cl.sendText(msg.to,"Yg tercogan!")
					ki.sendMessage(msg)
