...
wait = {
    ...
    'message':"""Thx for add""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By Y-A_Bot😊\n\n☆º°˚˚✰ ΥυδHΔ βΟτ ✰º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by M.WiraYudhaP👈 »»» http://line.me/ti/p/~iniyud «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Don't Tag Me! iam Bussy!, ",cName + "Ada perlu apa ?",cName + " pc aja klo urgent! sedang sibuk", "kenapa? ", cName + " kangen?","kangen bilang gak usah tag tag " + cName, "knp? " + cName, "apasi? " + cName + "?", "pulang gih " + cName ,"aya naon ?" + cName, "Tersangkut -_-","Tersummon_-","Yudha nya lagi off, pc aja kalo penting!","وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِوَبَرَكَاتُ"]
...
#======================== FOR COMMAND MODE ON STARTING ==========================#
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи ѕєт тσ σи")
                else:
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи αℓяєα∂у σи")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи αℓяєα∂у σи")
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи qя ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи qя ѕєт тσ σи")
                else:
                    wait["linkprotect"] = True
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи qя αℓяєα∂у σи")
                    else:
                        kr.sendText(msg.to,"ρяρтє¢тισи qя αℓяєα∂у σи")
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρтє¢тισи ιиνιтє ѕєт тσ σи")
                    else:
...
#======================== FOR COMMAND MODE OFF STARTING ==========================#
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи qя ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи qя ѕєт тσ σff")
                else:
                    wait["linkprotect"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρтє¢тισи qя αℓяєα∂у σff")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи qя αℓяєα∂у σff")
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи ιиνιтє ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи ιиνιтє ѕєт тσ σff")
                else:
                    wait["inviteprotect"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσє¢тισи ιиνιтє αℓяєα∂у σff")
                    else:
                        kr.sendText(msg.to,"ρяρтє¢тισи ιиνιтє αℓяєα∂у σff")
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи ¢αи¢єℓ ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи ¢αи¢єℓ ѕєт тσ σff")
                else:
                    wait["cancelprotect"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи ¢αи¢єℓ αℓяєα∂у σff")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи ¢αи¢єℓ αℓяєα∂у σff")
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"¢σитα¢т ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"¢σитα¢т ѕєт тσ σи")
                else:
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"¢σитα¢т αℓяєα∂у σи")
                    else:
                        kr.sendText(msg.to,"¢σитα¢т αℓяєα∂у σи")
            elif msg.text.lower() == 'contact off':
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"¢σитα¢т ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"¢σитα¢т ѕєт тσ σff")
                else:
                    wait["contact"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"¢σитα¢т αℓяєα∂у σff")
                    else:
                        kr.sendText(msg.to,"¢σитα¢т αℓяєα∂у σff")
            elif msg.text.lower() == 'protect on':
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρтє¢тισи ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"ρяρтє¢тισи ѕєт тσ σи")
                else:
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρтє¢тισи αℓяєα∂у σи")
                    else:
                        kr.sendText(msg.to,"ρяρтє¢тισи αℓяєα∂у σи")
            elif msg.text.lower() == 'qr on':
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρтє¢тισи qя ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"ρяρтє¢тισи qя ѕєт тσ σи")
                else:
                    wait["linkprotect"] = True
                ...
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        ...
                        kr.sendText(msg.to,"ρяρє¢тισи ѕєт тσ σff")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи αℓяєα∂у σff")
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρє¢тισи qя ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"ρяρє¢тισи qя ѕєт тσ σff")
                else:
                    wait["linkprotect"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяρє¢тισи qя αℓяєα∂у σff")
                    else:
                        kr.sendText(msg.to,"ρяρє¢тισи qя αℓяєα∂у σff")
            elif msg.text.lower() == 'invite off':
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσє¢тισи ιиνιтє ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"ρяσє¢тισи ιиνιтє ѕєт тσ σff")
                else:
                    wait["inviteprotect"] = False
                ...
                msg.contentMetadata = {'mid': "uecc57cb55f480ee2a45d81434a9b864d"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'❂➣ Creator yang paling cogan!  􀜁􀄯􏿿')
