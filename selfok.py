...
Bots=[mid]
owner=["uecc57cb55f480ee2a45d81434a9b864d","u3bec4cf8da7f4403f9228651c4fde5ea","ubdf4908b063316d7a64cea9e00ac418d",mid]
admin=["uecc57cb55f480ee2a45d81434a9b864d","u3bec4cf8da7f4403f9228651c4fde5ea","ubdf4908b063316d7a64cea9e00ac418d",mid]
baby=["uecc57cb55f480ee2a45d81434a9b864d","u3bec4cf8da7f4403f9228651c4fde5ea","ubdf4908b063316d7a64cea9e00ac418d"]#chery/barby/ranita
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "uecc57cb55f480ee2a45d81434a9b864d"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'❂➣ Creator yang ganteng  􀜁􀄯􏿿')
...
#================================ KRIS SCRIPT STARTED ==============================================#
                    ...
                    b = urllib.quote(a)
                    kr.sendText(msg.to,"Sedang Mencari kak...")
                    kr.sendText(msg.to, "https://www.google.com/" + b)
                    kr.sendText(msg.to,"Ketemu kak ^")
...
#--------------------------------------------------------
                ...
                if msg.from_ in owner:
                    ...
                    msg.contentMetadata = {'mid': "uecc57cb55f480ee2a45d81434a9b864d',"}
                    kr.sendMessage(msg)
            elif msg.text in ["yud","Yud","Yudha","yudha"]:
                if msg.from_ in owner:
                    kr.sendText(msg.to,"yudha masih aktif Bebz...!!!")
#=============================================
        if op.type == 17:
        ...
        if op.type == 15:
            if wait["Lv"] == True:
                if op.param2 in Bots:
                    return
                kr.sendText(op.param1, "Baper Tuh Orang :v")
